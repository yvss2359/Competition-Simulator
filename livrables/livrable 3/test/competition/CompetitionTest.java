...
public abstract class CompetitionTest{
    ...
    protected Observer ob1,ob2;
    protected List<Competitor> l;
    protected List<Observer> lo;
    protected Match m;
    protected abstract Competition createCompetition(List<Competitor> list, Match match, List<Observer> ob);
    ...
    public void init(){
        ...
        Observer bookmaker = new BookMaker ("PMU",l);
        
        lo.add(journalist);
        lo.add(bookmaker);
        
        this.cmp= createCompetition(l,m,lo);
    ...
    public void addObserversTest() {
    	this.init();
    	assertEquals(2,this.cmp.getMatch().observers.size());//car addObservers est appellé a la creation de la competition
    }
}